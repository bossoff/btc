                        ...
                        <div class="row text-center">
                              <div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 res-m-bttm">
                                    <div class="box round shadow-alt">
                                          <img src="<?=base_url();?>web/images/box-icon-a.png" alt="box-icon" class="box-icon">
                              ...
                              <div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 res-m-bttm">
                                    <div class="box round shadow-alt">
                                          <img src="<?=base_url();?>web/images/box-icon-e.png" alt="box-icon" class="box-icon">
                              ...
                              <div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2">
                                    <div class="box round shadow-alt">
                                          <img src="<?=base_url();?>web/images/box-icon-c.png" alt="box-icon" class="box-icon">
            ...
            <div class="container">
                        ...
                        <div class="col-md-4">
                              <div class="icon-block">
                                    <div class="icon-image">
                                          <img src="<?=base_url();?>web/images/icon-a.png" alt="icon">
                                    </div>
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-4">
                              <div class="icon-block">
                                    <div class="icon-image">
                                          <img src="<?=base_url();?>web/images/icon-b.png" alt="icon">
                                    </div>
                                    <p>Many services nowadays offer their users to buy Bitcoins, Lorem ipsum dolor sit</p>
      ...
      <div class="section section-pad cta-section">
            <div class="imagebg has-parallax">
                        <img src="<?=base_url();?>web/images/cta-light-bg.jpg" alt="cta-light">
                  </div>
            <div class="container">
                  <div class="row text-center">
                        <div class="col-md-8 col-md-offset-2">
